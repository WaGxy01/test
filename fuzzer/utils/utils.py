...
# new code add
def get_runtime_bytecode(solc_version, evm_version, source_file, contract_name):
    """获取运行时字节码"""
    compiler_output = compile(solc_version, evm_version, source_file)
    if not compiler_output:
        return None
    contract = compiler_output['contracts'][source_file][contract_name]
